  ...
  return (
    <Layout>
      <SEO
        ...
        description={`The Privacy Policy for Furry Canines has been created with the
        help of Termsfeed We use your data to provide and improve the
        Service.`}
      />
      <Header />
      <main className="page" role="main" itemScope itemProp="mainContentOfPage">
        ...
        <section className="page__content">
          <strong>Effective date: October 26, 2019</strong>
          <p>
            Furry Canines (“us”, “we”, or “our”) operates the{" "}
            <Link to="/">Furrycanines.com</Link> website (hereinafter referred
            ...
            data. The Privacy Policy for Furry Canines has been created with the
            help of Termsfeed We use your data to provide and improve the
            ...
            accessible from <Link to="/">Furrycanines.com</Link>
          </p>
          <h2>Definitions</h2>
          <ul>
            <li>
              <strong>Service</strong> Service is the{" "}
              <Link to="/">Furrycanines.com</Link>
              website operated by Furry Canines
            </li>
            <li>
          ...
          <h2>Use Of data</h2>
          <p>Furry Canines uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Furry Canines may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the right or property of Furry Canines
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              analytics service. Read the Privacy Policy from Google Analytics
              here:
              <a
          ...
          <ul>
            <li>By Email: info@furrycanines.com</li>
          </ul>
        </section>
      </main>
